...
public enum Authority {
     ...
     * @param value 权限int值
     * @return: com.fall.adminserver.constant.Authority
     * @date 2023/4/16 下午2:52
     */
    public static Authority IntToAuthority(int value) {
        try {
            return Authority.values()[value];
        } catch (Exception e) {
     ...
     */
    public static Authority NameToAuthority(String authorityName) {
